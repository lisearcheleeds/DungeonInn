...
- 帰還判断は冒険者の状態をスコア化し、しきい値を超えたら帰還する
- 帰還判断は毎フレーム全探索者を走査せず、戦闘終了・アイテム取得・討伐/経験/レベル変化・階層侵入などの節目で Dirty を立てた冒険者だけを評価する
- ダンジョン突入目的を達成したら帰還する
- HPが60%以下かつポーションなどの回復役が無い場合は帰還する
- HPが30%以下の場合は、回復役の有無や目的達成状況に関係なく帰還する
