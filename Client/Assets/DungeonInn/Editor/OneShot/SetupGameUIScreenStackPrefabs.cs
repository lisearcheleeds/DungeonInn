...
{
    public static class SetupGameUIScreenStackPrefabsOneShot
    {
        const string PrefabDirectory = "Assets/DungeonInn/Runtime/Prefab/GameUI/ScreenStack";
        ...
        public static void Run()
        {
            ...
            Debug.Log("[DungeonInn] GameUI ScreenStack prefabs updated.");
        }

        static void CreateOrUpdateWindowPrefab<TWindow>(string prefabName)
            where TWindow : GameUIScreenStackWindowBase
        {
