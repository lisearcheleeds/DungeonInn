...
{
    public sealed class GuildStaffAiPolicy : IActorAiPolicy
    {
        public bool CanHandle(Actor actor)
        {
            return actor.Behavior is GuildStaffBehavior;
        }
        ...
        public ActorAiDecision EvaluateLongTerm(ActorAiContext context)
        {
            ...
            return new ActorAiDecision(
                new ActorGoal(ActorGoalType.WorkAtFacility, 0, 0, 0),
                null,
                null);
        }
        ...
        public ActorAiDecision EvaluateMidTerm(ActorAiContext context)
        {
            ...
            return new ActorAiDecision(
                null,
                new ActorPlan(ActorPlanType.WorkAtFacility, 0, 0),
                null);
        }
