...
{
    public sealed class MarketOfferRequirementSummary
    {
        public MarketOfferRequirementSummary(int itemId, string itemName, int requiredCount, int ownedCount)
        {
            if (itemId < 1)
            {
        ...
        public bool IsSatisfied => MissingCount == 0;
    }
}
