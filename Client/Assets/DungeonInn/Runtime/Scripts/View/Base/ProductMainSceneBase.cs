...
namespace DungeonInn.Runtime.Scripts.View.Base
{
    ...
    public abstract class ProductMainSceneBase<TTransitionData> : MainSceneBase<TTransitionData>
        where TTransitionData : ProductTransitionDataBase
    {
        ...
        protected virtual InputActionMap GetInputLayerActionMap(InputActions inputActions) => inputActions.Scene;
