...
{
    public sealed class GameUIWindowOpenService : IGameUIWindowOpenService
    {
        readonly IScreenStackModule screenStackModule;
        readonly GameUIScreenStackViewDataFactory viewDataFactory;
        ...
        [Inject]
        public GameUIWindowOpenService(
            IScreenStackModule screenStackModule,
            GameUIScreenStackViewDataFactory viewDataFactory,
        ...
        {
            Debug.Log("[GameUI.ScreenStack] Open requested: SystemMenuWindow");
        ...
        {
            Debug.Log("[GameUI.ScreenStack] Open requested: DungeonInfoWindow");
            screenStackModule.Open(new DungeonInfoWindowData(viewDataFactory.CreateDungeonInfo())).Forget();
        }

        public void OpenGuildManagement()
        {
            Debug.Log("[GameUI.ScreenStack] Open requested: GuildManagementWindow");
        ...
        {
            Debug.Log("[GameUI.ScreenStack] Open requested: MarketWindow");
