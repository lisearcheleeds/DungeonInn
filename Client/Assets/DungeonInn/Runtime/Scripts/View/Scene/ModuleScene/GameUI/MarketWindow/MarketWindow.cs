...
namespace DungeonInn.View.Scene.ModuleScene.GameUI.ScreenStack
{
        ...
        IScreenStackSetup<MarketWindowData>
    {
        ...
        void Refresh()
        {
            ...
            Debug.Log($"[GameUI.ScreenStack] MarketWindow displayed. Offers={screenStackData.ViewData.Offers.Count}");
        }
        ...
        void FulfillOffer(int offerId)
        {
            ...
            Debug.Log($"[GameUI.ScreenStack] Market offer fulfilled from UI. OfferId={offerId}");
