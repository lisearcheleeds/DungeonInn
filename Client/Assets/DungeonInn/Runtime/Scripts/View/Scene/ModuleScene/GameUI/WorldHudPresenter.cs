...
namespace DungeonInn.View.Scene.ModuleScene.GameUI
{
    public sealed class WorldHudPresenter : IDisposable
    {
        ...
        readonly IGameUIWindowOpenService windowOpenService;
        ...
        public WorldHudPresenter(
            ...
            IGameUIWindowOpenService windowOpenService)
        {
        ...
        void EnsureHudView()
        {
            if (hudView != null || gameUIModuleScene.UICanvas == null)
            {
                return;
            }

            hudView = viewFactory.CreateWorldHudView(gameUIModuleScene.UICanvas.transform);
        }
    }
}
