    ...
    public sealed class ActorHUDViewPool : IInitializable, IDisposable
    {
...
#endif
            view.transform.SetParent(hudCanvasProvider.HUDCanvas.transform, false);
        ...
        ActorStatusView InstantiateView()
        {
            ...
            var view = prefab != null
                ? Object.Instantiate(prefab, hudCanvasProvider.HUDCanvas.transform)
                : CreateFallbackView();
        ...
        ActorStatusView CreateFallbackView()
        {
            ...
            viewObject.transform.SetParent(hudCanvasProvider.HUDCanvas.transform, false);
