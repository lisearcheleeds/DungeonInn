...
namespace DungeonInn.GameSession.Settings
{
    ...
    public sealed class WorldGameSettingsSO : ScriptableObject
    {
        ...
        public int MapChunkTileSize => mapChunkTileSize;
        public int MapChunkBuildsPerFrame => mapChunkBuildsPerFrame;
        public float MapTileHeightMeters => mapTileHeightMeters;
